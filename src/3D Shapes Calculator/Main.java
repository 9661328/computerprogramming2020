  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      if (shape.equals("1")) {
        ...
        double a = scanner.nextDouble();
        Polyhedron polyhedron = new Polyhedron(a);
        if (polyhedron.nonnegative()) {
          System.out.println("");
          System.out.println("calculations here");
          //
        } else {
          System.out.println("\nInvalid input: Values cannot be zero or negative!");
        }
        ...
        if (prism.nonnegative()) {
          System.out.println("");
          System.out.println("Name: " + prism.newName());
        ...
        System.out.println("*currently only calculates rectangular pyramid");
        System.out.println(Pyramid.name + ": " + Pyramid.par + "\n");
        int a = scanner.nextInt();
        double b = scanner.nextDouble();
        double c = scanner.nextDouble();
        double d = scanner.nextDouble();
        Pyramid pyramid = new Pyramid(a, b, c, d);
